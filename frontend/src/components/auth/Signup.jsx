            ...
            <div className="relative z-10 max-w-xs border border-zinc-700 bg-zinc-900 rounded-2xl shadow-lg p-8 w-full">
                ...
                <div className="text-center mb-12">
                    <div className="flex items-center justify-center gap-2 mb-8">
                        ...
                        <span className="text-white text-2xl font-bold">eye<span className="text-amber-600">Q</span> signup</span>
                        <span></span>
                    </div>
                ...
                <div className="text-center mt-4">
                    ...
                    >
                        already have account <span className="font-semibold text-[#F2F0EF] underline">Login</span>
                    </button>
                </div>
            </div>
        </div>
